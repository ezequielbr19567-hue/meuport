            ...
            {content.media.map((item, index) => (
              <div className="adminItem" key={index}>
                ...
                {item.type === "image" ? (
                  ...
                  <label>URL do vídeo <span className="sharedField">YouTube/Vimeo/MP4</span><input className="adminInput" value={item.url} onChange={(e) => updateMedia(index, { ...item, url: e.target.value })} placeholder="https://..." /></label>
                )}
        ...
        {projects.map((project, index) => (
          <div className="adminItem" key={index}>
            ...
            <div className="adminGrid2">
              ...
              />
              <label>Vídeo opcional <span className="sharedField">URL</span><input className="adminInput" value={project.video || ""} onChange={(e) => onUpdate(index, { ...project, video: e.target.value })} placeholder="https://..." /></label>
            </div>
