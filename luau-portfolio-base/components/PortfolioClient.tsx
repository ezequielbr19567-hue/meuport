...
const ui = {
  en: {
    ...
    separateArea: "TECHNICAL SUPPORT",
    ...
    builderDescription: "Maps, environments, interiors and playable spaces built with strong composition, lighting and a clear visual identity.",
    programmingKicker: "PROGRAMMING",
    programmingTitle: "Systems and technical support",
    programmingDescription: "Luau systems, interfaces and technical support designed to complement production and keep experiences reliable.",
    pricingKicker: "PRICING",
    pricingTitle: "Services & pricing",
    pricingDescription: "Starting points for different project scopes. Final pricing may vary with scale, complexity and delivery requirements.",
    mediaKicker: "MEDIA",
    ...
    stackDescription: "A practical toolkit for building polished Roblox experiences, from world creation to the systems behind them.",
    builder: "BUILDER",
    contactKicker: "CONTACT",
    contactTitle: "Need a map, environment or technical support for your game?",
    contactDescription: "Available for commissions, collaborations and long-term projects.",
    email: "Email",
  ...
  pt: {
    ...
    builderDescription: "Mapas, ambientes, interiores e espaços jogáveis com composição forte, iluminação e identidade visual clara.",
    programmingKicker: "PROGRAMAÇÃO",
    programmingTitle: "Sistemas e suporte técnico",
    programmingDescription: "Sistemas em Luau, interfaces e suporte técnico pensados para complementar a produção e manter a experiência confiável.",
    pricingKicker: "VALORES",
    pricingTitle: "Serviços e valores",
    pricingDescription: "Pontos de partida para diferentes escopos. O valor final pode variar conforme escala, complexidade e prazo de entrega.",
    mediaKicker: "MÍDIA",
    ...
    stackDescription: "Um conjunto prático de habilidades para criar experiências polidas no Roblox, da construção do mundo aos sistemas por trás dele.",
    builder: "BUILDER",
    contactKicker: "CONTATO",
    contactTitle: "Precisa de um mapa, ambiente ou suporte técnico para o seu jogo?",
    contactDescription: "Disponível para comissões, colaborações e projetos de longo prazo.",
    email: "E-mail",
    footer: "Builder • Roblox Studio • Luau",
