# Versão V13 — carregamento confiável

Comece por `MELHORIAS-V13.md`. A V13 corrige o retorno indevido ao conteúdo padrão e protege a edição das configurações. Os testes atuais estão em `VALIDACAO-V13.md`. As notas e prévias da V12 abaixo são históricas.
