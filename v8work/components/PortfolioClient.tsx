...
const ui = {
  en: {
    ...
    programmingDescription: "Luau systems, interfaces and modular architecture built for reliable gameplay.",
  ...
  pt: {
    ...
    programmingDescription: "Sistemas em Luau, interfaces e arquitetura modular para funcionalidades confiáveis.",
